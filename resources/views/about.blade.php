...
<div class="container p-5 mt-5 mb-3">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-5 pl-4 pt-2">
                    <p>Idade: {{ \Carbon\Carbon::parse('2000-02-03')->age }} anos</p>
                </div>
                <div class="col-md-7 pt-2">
        ...
        <div class="col-md-6 d-flex flex-column align-items-center dark-shadow-v border-top border-end border-primary rounded">
            <p class="mt-4 fw-bold">Desenvolvedora Web & Estudante de TI 💻✨</p>
            <p class="px-4 py-2">Sou graduanda em Tecnologia da Informação e apaixonada por transformar linhas de código em soluções reais. Minha jornada prática no desenvolvimento web envolve criar e manter sites e sistemas, tanto em projetos profissionais quanto em freelas, dominando o bom e velho ecossistema de PHP, HTML, CSS, JavaScript, jQuery e MySQL. Atualmente, meu foco está em dar o próximo passo técnico: estou mergulhada de cabeça no universo do Laravel, na criação de APIs REST e em automações inteligentes que facilitam o dia a dia, usando N8N e Evolution API.</p>
        </div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-3 p-5">
            <img class="img-icon" alt="Git"
                src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg">
            <p class="mt-2 fw-bold">Git</p>
        </div>
    </div>
    <div class="row text-center">
        <div class="col-md-3 p-5">
        ...
        <div class="col-md-3 p-5">
            <img class="img-icon" alt="Laravel"
                src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-line.svg">
            <p class="mt-2 fw-bold">Laravel</p>
        </div>
        <div class="col-md-3 p-5">
            <img class="img-icon" alt="Docker"
                src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg">
            <p class="mt-2 fw-bold">Docker</p>
        </div>
    </div>
</div>
